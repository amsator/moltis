...
git worktree add ../butler-feature-name -b feature/feature-name

# Navigate to the worktree
cd ../butler-feature-name
```
...
cd /Users/penso/tmp/butler
git worktree remove ../butler-feature-name
```
...
3. Ensure `.env`, and similar files are in `.gitignore`
